            ...
            <div class="container-fluid">
                            ...
                            <div class="card-body">
                                ...
                                <div class="m-t-20">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::file('restaurant_image', old('image'), ['id'=>'restaurant_image','class' => 'filestyle','onchange' => "preview()",'data-buttonname'=> "btn-primary"]) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="$userdata->country_code" name="country_code" value="{{$userdata->country_code}}" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {!! Form::label('name', 'Pincode') !!}<span class="text-danger">*</span>
                                                {!! Form::text('pincode', old('name'), ['class' => 'form-control', 'placeholder' => 'Pincode','id'=>'pincode']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        @php
                                        $restaurant_type = '';
                                        if($userdata->restaurant_type !=''){
                                        $restaurant_type = explode(',',$userdata->restaurant_type);
                                        }
                                        @endphp
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Restaurant Type<span style="color:red">*</span></label>
                                                <select id="restaurant_type" name="restaurant_type[]" class="form-control select2" multiple>
                                                    <option value="1" @if(in_array("1",$restaurant_type)) @php echo 'selected' ; @endphp @endif>Low</option>
                                                    <option value="2" @if(in_array("2",$restaurant_type)) @php echo 'selected' ; @endphp @endif>High</option>
                                                    <option value="3" @if(in_array("3",$restaurant_type)) @php echo 'selected' ; @endphp @endif>Expensive</option>

                                                </select>
                                                <span id="restaurant_typeerror" style="color:red;"><span>
                                            </div>
                                        </div>
                ...
                <script>
                    ...
                    function validate() {
                        ...
                        if (pincode.trim() == '') {
                            $("#pincodeoerror").html("Please enter Pincode");
                            temp++;
                        } else {
                            $("#pincodeoerror").html("");
                        }
