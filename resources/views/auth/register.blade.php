    ...
    <div class="wrapper-page">
        <div class="card card-pages">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ url('verify-register') }}" autocomplete="off" onsubmit="return validate()" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="cuisine_id" name="cuisine_id" class="form-control select2">
                                    ...
                                    <option value="{{$ckey->id}}">{{$ckey->cuisine_name}}</option>
                                    @endforeach
                                    @endif
                                </select>
                    ...
                    <div class="row">
                        ...
                        <input id="checkbox-signup" type="checkbox" id="terms_and_conditions"
                            ...
                            I accept  <a href="{{route('terms-conditions')}}" target="_blank">Terms and Conditions &</a>
                                <a href="{{route('privacy-policy')}}" target="_blank">Privacy&Policy and</a>
