                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <a href="{{route('delivery-person.create')}}" class="btn btn-normal btn-primary btn-sm float-right"><i class="fa fa-fw fa-plus-square"></i> Add</a>
                                                    <h4 class="m-b-30 m-t-0">Delivery Person List</h4>
                                                </div>
                                                <div class="card-body">
...
<script>
    ...
    function loadData() {
        ...
        $('#category-table').DataTable({
            ...
            "searching": false,
            "ajax": {
                url: "{{route('delivery-person-data')}}?" + formData,
                method: "get"
            }
        });
    }
