    ...
    <div class="content">
        ...
        <div class="">
            <div class="page-header-title">
                <h4 class="page-title">User Book Table Detail</h4>
            </div>
        </div>
                                                ...
                                                <table id="menu-table" class="table table-striped table-bordered dt-responsive" style="border-collapse: collapse; width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{isset($rwData->tableTime->time_from) ? date("h:i A",strtotime($rwData->tableTime->time_from)) : 'N/A'}} - {{isset($rwData->tableTime->time_to) ? date("h:i A",strtotime($rwData->tableTime->time_to)) : 'N/A'}}</td>
