        ...
        <div class="page-content-wrapper ">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h3 class="header-title m-t-0"><small class="text-primary"><b>Table Number Add</b></small></h3>

                                        <div class="m-t-20">
                                            {!! Form::open(['method' => 'POST', 'route' => ['table-number.store'], 'files' => true,'id'=>'book-table-add']) !!}
                                            ...
                                            <div class="form-group">
                                                <div>
                                                    ...
                                                    {!! Form::text('duration', old('duration'), ['class' => 'form-control only-numeric','id'=>'duration', 'placeholder' => 'Enter Table Duration','maxlength' => "3"]) !!}
                                            ...
                                            <div class="form-group">
                                                <div>
                                                    <button type="submit" id="crateBtn" onclick="return validation();" class="btn btn-primary waves-effect waves-light">
                                                        Submit
                                                    </button>
            ...
            <script>
                function validation() {
                    ...
                    if (temp == 0) {
                        $("#crateBtn").prop('disabled', true);
                        $("#book-table-add").submit();
                        return true;
                    } else {
                        return false;
                    }
