            ...
            <div class="card-body">
              ...
              <div class="card-tools">
                <div class="text-center mt-0 mb-3">
                  <a href="{{route('cuisine.edit',$cuisine->id)}}" class="btn btn-sm btn-primary" title="Edit">Edit</a>
                  <a id="delete" href="javascript:void(0);" class="btn btn-sm btn-danger" title="Delete">Delete</a>
                  <form action="{{ route('cuisine.destroy', $cuisine->id)}}" method="POST" id="deleteForm">
                    @csrf
                    ...
                    <div class="col-12 col-sm-6">
                      <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b>Cuisine Name</b><span class="category-section ml-3">{{$cuisine->cuisine_name !="" ? $cuisine->cuisine_name : 'N/A'}}</span>
                        </li>
                    </div>
                  </div>
                </div>
