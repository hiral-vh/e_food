                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h3 class="header-title m-t-0"><small class="text-primary"><b>Discount Add</b></small></h3>

                                        <div class="m-t-20">
                                            {!! Form::open(['method' => 'POST', 'files' => true ,'route' => ['discount.store'],'id'=>'food-menu-add' ,'autocomplete' => 'off']) !!}
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::select('discount_type', [null => 'Select Discount Type','Amount' => 'Amount','Percentage' => 'Percentage'],null, ['class' => 'form-control','id'=>'discount_type','onchange' => "divShowHide(this.value)"]) !!}
                                            ...
                                            <div class="col-md-12" id="discount_percentageDiv" style="display:none;">
                                                <div class="form-group">
                                                    {!! Form::label('discount_percentage', 'Discount Percentage') !!}<span class="text-primary">*</span>
                                                    {!! Form::text('discount_percentage', old('discount_percentage'), ['class' => 'form-control only-numeric','placeholder' => 'Enter Discount Percentage','id'=>'discount_percentage','maxlength' => "2"]) !!}
                                            ...
                                            <div class="col-md-12" id="discount_amountDiv" style="display:none;">
                                                <div class="form-group">
                                                    {!! Form::label('discount_amount', 'Discount Amount') !!}<span class="text-primary">*</span>
                                                    {!! Form::text('discount_amount', old('discount_percentage'), ['class' => 'form-control number','placeholder' => 'Enter Discount Amount','id'=>'discount_amount','maxlength' => "5"]) !!}
                                                    <span class="text-primary">@error ('discount_percentage') {{$message}}@enderror</span>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-daterange input-group" id="date-range">
                                                        <input type="text" id="discount_start_date" class="form-control" name="discount_start_date" placeholder="Discount Start Date" />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text bg-primary text-white b-0">to</span>
                                                        </div>
                                                        <input type="text" id="discount_end_date" class="form-control" placeholder="Discount End Date" name="discount_end_date" />
                                                    </div>
                                                    <span class="text-primary">@error ('discount_percentage') {{$message}}@enderror</span>
                ...
                <script>
                    function validation() {
                        ...
                        if (discount_start_date == '' && discount_end_date == '') {
                            $("#daterangeerror").html("Please enter Discount Start Date and Discount End Date");
                            temp++;
                        } else {
                            $("#daterangeerror").html("");
                        }
