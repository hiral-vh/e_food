...
<script src="<?php echo e(asset('admin/js/daterangepicker.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('admin/plugins/fullcalendar/js/fullcalendar.min.js')); ?>"></script>

<!-- KNOB JS -->
<script src="<?php echo e(asset('admin/plugins/jquery-knob/excanvas.js')); ?>"></script>
<script src="<?php echo e(asset('admin/plugins/jquery-knob/jquery.knob.js')); ?>"></script>

<script src="<?php echo e(asset('admin/plugins/flot-chart/jquery.flot.min.js')); ?>"></script>
<script src="<?php echo e(asset('admin/plugins/flot-chart/jquery.flot.tooltip.min.js')); ?>"></script>
<script src="<?php echo e(asset('admin/plugins/flot-chart/jquery.flot.resize.js')); ?>"></script>
<script src="<?php echo e(asset('admin/plugins/flot-chart/jquery.flot.pie.js')); ?>"></script>
<script src="<?php echo e(asset('admin/plugins/flot-chart/jquery.flot.selection.js')); ?>"></script>
<script src="<?php echo e(asset('admin/plugins/flot-chart/jquery.flot.stack.js')); ?>"></script>
<script src="<?php echo e(asset('admin/plugins/flot-chart/jquery.flot.crosshair.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\e_food\resources\views/admin/layouts/footer.blade.php ENDPATH**/ ?>