                    ...
                    <div class="card">
                        <div class="card-heading p-4">
                            <div class="flex-dash-card">
                                <div>
                                    <input class="knob" data-width="80" data-height="80" data-linecap=round data-fgColor="#fa9d4f" value="<?php echo e($numberOfOrders->count()); ?>" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                                </div>
                                <div class="float-right ml-12px">
                                    <h2 class="text-primary mb-0 card-dashfn"><?php echo e($numberOfOrders->count()); ?></h2>
                    ...
                    <div class="card">
                        <div class="card-heading p-4">
                            <div class="flex-dash-card">
                                ...
                                <div class="float-right ml-12px">
                                    <h2 class="text-primary mb-0 card-dashfn"> <?php echo e($totalRemainingOrders->total_orders); ?></h2>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card">
                        <div class="card-heading p-4">
                            <div class="flex-dash-card">
                                <div>
                                    <input class="knob" data-width="80" data-height="80" data-linecap=round data-fgColor="#fa9d4f" value="<?php echo e($totalBookingTableCount->count()); ?>" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                                </div>
                                <div class="float-right ml-12px">
                                    <h2 class="text-primary mb-0 card-dashfn"><?php echo e($totalBookingTableCount->count()); ?></h2>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card">
                        <div class="card-heading p-4">
                            <div class="flex-dash-card">
                                <div>
                                    <input class="knob" data-width="80" data-height="80" data-linecap=round data-fgColor="#fa9d4f" value="<?php echo e($totalSales); ?>" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                                </div>
                                <div class="float-right ml-12px">
                                    <h2 class="text-primary mb-0 card-dashfn">£<?php echo e($totalSales); ?></h2>
                                    ...
                                    <div class="col-4">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <span class="error" id="validTillSpan"> <?php echo e($errors->add->first('valid_till')); ?></span>
...
<div id="custom-width-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <?php echo Form::open(['method' => 'POST', 'files' => true, 'route' => ['topup-orders'], 'id' => 'food-menu-add']); ?>

            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <?php echo Form::label('total_order', 'Total Orders'); ?><span class="text-primary">*</span>
                        ...
                        <div class="form-group">
                            <?php echo Form::label('total_days', 'Total Days'); ?><span class="text-primary">*</span>
   ...
   // var graphArray1 = [['Date', 'Bookings']];
    function searchGraph(searchType = '') {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: '<?php echo e(route("get-monthly-data")); ?>',
            data: {
...
<script>
    ...
    function openModel() {
        $("#total_order").val('');
        $("#total_days").val('<?php echo e($diffrenceDay); ?>');
    ...
    function validateForm() {
        ...
        if (total_days == '') {
            ...
            var diffrenceDay = '<?php echo e($diffrenceDay); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e_food\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>